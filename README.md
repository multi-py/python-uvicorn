...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-0.21.1
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.11-0.21.1`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.11-slim-0.21.1`
