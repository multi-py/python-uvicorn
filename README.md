...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.12-0.50.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.12-0.50.0`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.12-slim-0.50.0`
