...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-0.23.2
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.11-0.23.2`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.11-slim-0.23.2`
