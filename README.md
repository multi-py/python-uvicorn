...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.12-0.52.3
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.12-0.52.3`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.12-slim-0.52.3`
