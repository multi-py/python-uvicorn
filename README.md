...
```bash
docker pull ghcr.io/multi-py/python-uvicorn:py3.10-alpine-LATEST
```

To include it in the dockerfile instead:

```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.10-alpine-LATEST
```
...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.10-0.18.2
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.10-0.18.2`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.10-slim-0.18.2`
