...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.12-0.30.1
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.12-0.30.1`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.12-slim-0.30.1`
