...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-0.19.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.11-0.19.0`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.11-slim-0.19.0`
