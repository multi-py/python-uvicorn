...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.12-0.49.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.12-0.49.0`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.12-slim-0.49.0`
