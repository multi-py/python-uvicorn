...
```bash
docker pull ghcr.io/multi-py/python-uvicorn:py3.11-LATEST
```

To include it in the dockerfile instead:

```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-LATEST
```
...
```bash
docker pull ghcr.io/multi-py/python-uvicorn:py3.11-slim-LATEST
```
...
```bash
docker pull ghcr.io/multi-py/python-uvicorn:py3.11-alpine-LATEST
```

To include it in the dockerfile instead:

```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-alpine-LATEST
```
...
COPY --from=ghcr.io/multi-py/python-uvicorn:py3.11-slim-LATEST /usr/local/lib/python3.11/site-packages/* /usr/local/lib/python3.11/site-packages/
```
...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-0.21.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.11-0.21.0`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.11-slim-0.21.0`
