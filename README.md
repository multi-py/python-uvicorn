...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.11-0.22.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.11-0.22.0`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.11-slim-0.22.0`
