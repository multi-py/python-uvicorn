...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.10-0.17.2
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.10-0.17.2`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.10-slim-0.17.2`
