...
```dockerfile
FROM ghcr.io/multi-py/python-uvicorn:py3.12-0.30.3
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-uvicorn:py3.12-0.30.3`
* Slim Image: `ghcr.io/multi-py/python-uvicorn:py3.12-slim-0.30.3`
